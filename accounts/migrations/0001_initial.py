...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avatar', models.ImageField(default='images/Default.jpg', upload_to='images/', verbose_name='avatar')),
                ('point', models.PositiveIntegerField(default=0, verbose_name='point')),
                ('coin', models.PositiveIntegerField(default=0, verbose_name='coin')),
                ('reported_times', models.IntegerField(default=0, verbose_name='reported times')),
